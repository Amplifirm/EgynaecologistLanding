      ...
      <section className="va-hero">
        <div className="va-container">
          <div className="va-hero-content">
            ...
            <h1>See Our Gynaecologist <span>In-Person at Harley Street Clinic or Online</span></h1>
            <p className="va-hero-sub">Expert women's healthcare from specialist consultants. Same-week appointments, AI-powered triaging, and clear upfront pricing. No GP referral needed.</p>
          ...
          <div className="va-hero-image-wrap">
            <img src={IMAGES.hero} alt="Private gynaecology consultation at eGynaecologist, Harley Street" className="va-hero-image" />
      ...
      <section className="va-section va-text-center">
        <div className="va-container">
          ...
          <div className="va-steps-grid">
            <div className="va-step-card"><div className="va-step-number">1</div><h3>Book Online</h3><p>Choose in-person or remote appointment. No GP referral needed. Fill in a short pre-consultation questionnaire and our AI-powered triaging prepares your consultation with the right consultant for you.</p></div>
            <div className="va-step-card"><div className="va-step-number">2</div><h3>See Your Consultant</h3><p>Meet a specialist gynaecologist at our Harley Street clinic or via secure telemedicine video link. Focused, purposeful consultations with clear outcomes.</p></div>
            <div className="va-step-card"><div className="va-step-number">3</div><h3>Get Your Plan</h3><p>Receive a personalised treatment plan, investigations and prescription if needed, and ongoing support -- all from one integrated care team.</p></div>
          </div>
        </div>
      </section>
        ...
        <div className="va-container">
          ...
          <div className="va-doctor-grid">
            ...
            <div className="va-doctor-info">
              ...
              <p className="va-doctor-bio">At eGynaecologist, every consultation is led by an expert consultant gynaecologist practising evidence-based medicine. Our team brings subspecialist expertise across the full range of women's health services.</p>
              <ul className="va-credentials-list">
                <li><span className="va-check">&#10003;</span> GMC-registered and revalidated Consultants</li>
                <li><span className="va-check">&#10003;</span> MRCOG qualified and higher subspecialist training</li>
                <li><span className="va-check">&#10003;</span> CQC-regulated Harley Street practice</li>
                <li><span className="va-check">&#10003;</span> On-site consultant led diagnostics: ultrasound, colposcopy, hysteroscopy</li>
                <li><span className="va-check">&#10003;</span> Digital-first with AI-powered triaging</li>
        ...
        <div className="va-container va-text-center">
          ...
          <div className="va-pricing-grid">
            <div className="va-pricing-card">
              ...
              <ul className="va-pricing-features">
                <li><span className="va-check">&#10003;</span> Pre-assessment questionnaire</li>
                <li><span className="va-check">&#10003;</span> Self-Collect tests</li>
                <li><span className="va-check">&#10003;</span> Written summary & plan</li>
                <li><span className="va-check">&#10003;</span> Digital prescriptions if needed</li>
              </ul>
            ...
            <div className="va-pricing-card va-featured">
              ...
              <div className="va-price">&pound;275</div>
              <div className="va-price-note">Harley Street clinic visit</div>
              <ul className="va-pricing-features">
                <li><span className="va-check">&#10003;</span> Everything in Remote, plus:</li>
                <li><span className="va-check">&#10003;</span> Physical examination</li>
                <li><span className="va-check">&#10003;</span> On-site diagnostics available</li>
                <li><span className="va-check">&#10003;</span> Same-day results where possible</li>
              </ul>
              <button className="va-btn-primary va-btn-full" onClick={scrollToForm}>Book In-Person</button>
            </div>
            <div className="va-pricing-card">
              <h4>Care Bundles</h4>
              <div className="va-price">From &pound;330</div>
              <div className="va-price-note">Comprehensive packages</div>
              <ul className="va-pricing-features">
                <li><span className="va-check">&#10003;</span> PCOS, Endometriosis, Fertility, Recurrent Miscarriages</li>
                <li><span className="va-check">&#10003;</span> Sexual health screening, Coil fitting or Removals</li>
                <li><span className="va-check">&#10003;</span> Well Woman annual checks, Fibroid monitoring, Menopause bundles</li>
                <li><span className="va-check">&#10003;</span> Early Cancer Screening tests, BRCA tests, Lynch syndrome tests</li>
              </ul>
      ...
      <section className="va-section va-testimonials-section">
        <div className="va-container va-text-center">
          ...
          <div className="va-testimonials-grid">
            {[
              { text: '"I was so impressed with the level of care. The consultant was incredibly knowledgeable and took time to explain everything thoroughly. The whole process from booking to follow-up was seamless."', name: 'Amirtha D.', source: 'Doctify Review', img: IMAGES.amirtha },
        ...
        <div className="va-container va-text-center">
          ...
          <div className="va-faq-list">
            {[
              ...
              { q: 'Is this covered by health insurance?', a: 'Most of our consultants are recognised by all major insurers. Please check with your provider and have your pre-authorisation number ready when booking. Self-pay patients benefit from clear, upfront pricing with no hidden fees.' },
          ...
          <div className="va-form-grid">
            ...
            <div className="va-form-card">
              ...
              <form onSubmit={e => e.preventDefault()}>
                ...
                <div className="va-form-group"><label htmlFor="va-type">Consultation Type *</label><select id="va-type" required><option value="">Select consultation type</option><option value="remote">Remote Consultation (GBP 250)</option><option value="in-person">In-Person at Harley Street (GBP 275)</option><option value="not-sure">Not Sure -- Help Me Choose</option></select></div>
      ...
      <div className="va-partners-bar">
        <div className="va-container">
          ...
          <div className="va-partners-logos">
            ...
            <img src={IMAGES.biomedge} alt="BiomEdge" className="va-partner-logo" />
          </div>
        </div>
      </div>
